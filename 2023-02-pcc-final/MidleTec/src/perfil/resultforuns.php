...
$query = " SELECT * from midletech.foruns where proprietario  =  '$idusuario' and titulo like '%$buscar%' or proprietario  =  '$idusuario' and descricao like '%$buscar%';";
                ...
                <div class="mod">
                    <div class="div_login">
                        <form action="delete.php" method="post">
                            ...
                            <?php echo var_dump($_POST['excluir']) ?>
                        </form>
