...
// $query3 = " SELECT * from midletech.favoritos w ";
// $query4 = " SELECT * from midletech.material inner join midletech.favoritos on material.idmaterial  = favoritos.idmaterial and favoritos.idusuario='$usuario';";
...
<body>
    <header class="header_menu">
        <div class="div_menu">
            ...
            <div class="topnav">
                <form action="result_link.php" method="get">
                    ...
                    <article>
                        ...
                        <a href="<?php echo $row['8']; ?>" target="_blank">
                            <header>
                                ...
                                <p>
                                    <?php #$favoritar1 = $row['0']; ?>
                                    <?php #$favoritar2 = $_SESSION['idusuario']; ?>
