...
<div class="container">
    ...
    <form action="" method="POST">
        <div class="row">
            <div class="col-md-3">
                ...
                <input type="text" name="nome" class="form-control f_create_edit"
                    value="<?= $usuario_funcionario['nome'] ?>" />
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label>Email</label>
                <input type="email" name="email" class="form-control f_create_edit"
                    value="<?= $usuario_funcionario['email'] ?>" />
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <label>CEP</label>
                <input type="text" name="cep" class="form-control f_create_edit"
                    value="<?= $endereco_funcionario['cep'] ?>" maxlength="9" />
            </div>

            <div class="col-md-6">
                <label>Rua</label>
                <input type="text" name="rua" class="form-control f_create_edit"
                    value="<?= $endereco_funcionario['rua'] ?>" />
            </div>

            <div class="col-md-6">
                <label>Bairro</label>
                <input type="text" name="bairro" class="form-control f_create_edit"
                    value="<?= $endereco_funcionario['bairro'] ?>" />
            </div>

            <div class="col-md-6">
                <label>Cidade</label>
                <input type="text" name="cidade" class="form-control f_create_edit"
                    value="<?= $endereco_funcionario['cidade'] ?>" />
            </div>

            <div class="col-md-6">
                <label>Estado</label>
                <input type="text" name="estado" class="form-control f_create_edit"
                    value="<?= $endereco_funcionario['estado'] ?>" />
            </div>
