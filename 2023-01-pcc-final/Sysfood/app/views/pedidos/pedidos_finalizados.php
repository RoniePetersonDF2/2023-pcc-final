...
<div class="container">
    ...
    if (isset($_GET['search'])) {
        if ($_SERVER['REQUEST_METHOD'] === 'GET') {
            ...
            $nome = $_GET['search'];
            $pedidos = $pedidosController->pedidos_finalizados($_SESSION['funcionario']['sessao_id'], $nome);
        }
    } else {
        $pedidos = $pedidosController->pedidos_finalizados($_SESSION['funcionario']['sessao_id']);
    }
    ?>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <label for="">Pedido concluído em: <?= $pedido['hora_fim'] ?></label>
                            <?php endif; ?>
                        </div>
                        <div class="col-6">
