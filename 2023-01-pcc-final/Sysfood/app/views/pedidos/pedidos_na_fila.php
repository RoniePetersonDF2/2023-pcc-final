...
<div class="container">
    <div class="d-flex justify-content-between align-items-center" style="margin-top: 20px;">
        ...
        <?php
        if (isset($_SESSION['funcionario'])) {
            if ($_SESSION['funcionario']['cargo'] == "Funcionário Comum") {
                echo '<a href="../pedidos/create.php?id_sessao=' . $_SESSION['funcionario']['sessao_id'] . '"
    ...
    if (isset($_GET['search'])) {
        if ($_SERVER['REQUEST_METHOD'] === 'GET') {
            ...
            $nome = $_GET['search'];
            $pedidos = $pedidosController->pedidos_na_fila($_SESSION['funcionario']['sessao_id'], $nome);
        }
    } else {
