...
function calcularValorTotal() {
    ...
    var precoProduto = document.getElementById('preco_produto').textContent;
    precoProduto = parseFloat(precoProduto.replace('R$', ''));

    if (quantidade && !isNaN(quantidade)) {
        var valorTotal = quantidade * precoProduto;
                ...
                <div class="form-group">
                    ...
                    <select name="produto_id" id="produto_id" class="form-control" required>
                        ...
                        <option value="<?= $produto['id'] ?>"
                            <?= ($produto['id'] == $pedido_produto['produto_id']) ? 'selected' : '' ?>>
